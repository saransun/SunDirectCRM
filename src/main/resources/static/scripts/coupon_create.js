...
$(document).ready(function() {
	...
	$('#coupon_form').validate({
		...
		messages : {
			code : {
				remote : 'Coupon code has already exist.'
			}
		},
		submitHandler : function(form) {
			$('#coupomButton').prop('disabled', 'disabled');
	...
	$("input[name='codeType']").change(function() {
		var value = $(this).val();
		if (value == "bulk") {
			$('#singleCouponCodeDiv').hide();
			$('#bulkCouponCodeDiv').show();
			$('#bulkCouponFileCodeDiv').hide();
			$(".bulkCouponCodes").prop('required', true);
			$(".singleCode").prop('required', false);
		}else if(value == "bulkFile"){
			$('#bulkCouponFileCodeDiv').show();
			$('#bulkCouponCodeDiv').hide();
			$('#singleCouponCodeDiv').hide();
		} 
		else {
			$('#singleCouponCodeDiv').show();
			$('#bulkCouponCodeDiv').hide();
			$('#bulkCouponFileCodeDiv').hide();
			$(".bulkCouponCodes").prop('required', false);
			$(".singleCode").prop('required', true);
		}
	});
